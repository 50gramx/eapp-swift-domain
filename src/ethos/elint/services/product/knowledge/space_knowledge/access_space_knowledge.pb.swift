...
struct Elint_Services_Product_Knowledge_Space_SpaceKnowledgeServicesAccessAuthDetails {
...
/// Message Definitions
struct Elint_Services_Product_Knowledge_Space_AccessSpaceKnowledgeTokenRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var spaceAccessSessionTokenDetails: Elint_Entity_PersistentSessionTokenDetails {
    get {return _storage._spaceAccessSessionTokenDetails ?? Elint_Entity_PersistentSessionTokenDetails()}
    set {_uniqueStorage()._spaceAccessSessionTokenDetails = newValue}
  }
  /// Returns true if `spaceAccessSessionTokenDetails` has been explicitly set.
  var hasSpaceAccessSessionTokenDetails: Bool {return _storage._spaceAccessSessionTokenDetails != nil}
  /// Clears the value of `spaceAccessSessionTokenDetails`. Subsequent reads from it will return its default value.
  mutating func clearSpaceAccessSessionTokenDetails() {_uniqueStorage()._spaceAccessSessionTokenDetails = nil}
...
extension Elint_Services_Product_Knowledge_Space_SpaceKnowledgeServicesAccessAuthDetails: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".SpaceKnowledgeServicesAccessAuthDetails"
  ...
  static func ==(lhs: Elint_Services_Product_Knowledge_Space_SpaceKnowledgeServicesAccessAuthDetails, rhs: Elint_Services_Product_Knowledge_Space_SpaceKnowledgeServicesAccessAuthDetails) -> Bool {
...
extension Elint_Services_Product_Knowledge_Space_AccessSpaceKnowledgeTokenRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".AccessSpaceKnowledgeTokenRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "account"),
    2: .standard(proto: "space_access_session_token_details"),
    4: .standard(proto: "requested_at"),
  ]

  fileprivate class _StorageClass {
    var _account: Elint_Entity_Account? = nil
    var _spaceAccessSessionTokenDetails: Elint_Entity_PersistentSessionTokenDetails? = nil
    var _requestedAt: SwiftProtobuf.Google_Protobuf_Timestamp? = nil
    ...
    init(copying source: _StorageClass) {
      _account = source._account
      _spaceAccessSessionTokenDetails = source._spaceAccessSessionTokenDetails
      _requestedAt = source._requestedAt
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularMessageField(value: &_storage._account) }()
        case 2: try { try decoder.decodeSingularMessageField(value: &_storage._spaceAccessSessionTokenDetails) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._spaceAccessSessionTokenDetails {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
      }
      if let v = _storage._requestedAt {
  ...
  static func ==(lhs: Elint_Services_Product_Knowledge_Space_AccessSpaceKnowledgeTokenRequest, rhs: Elint_Services_Product_Knowledge_Space_AccessSpaceKnowledgeTokenRequest) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
        if _storage._account != rhs_storage._account {return false}
        if _storage._spaceAccessSessionTokenDetails != rhs_storage._spaceAccessSessionTokenDetails {return false}
        if _storage._requestedAt != rhs_storage._requestedAt {return false}
        return true
      }
      if !storagesAreEqual {return false}
